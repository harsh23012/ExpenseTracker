...
public class RemoteGroupStatelessHelper {
	...
	private static Context createInitialContext() throws NamingException {
	   ...
	   public static GroupStatelessBeanRemote lookupRemoteStatelessGroup() throws NamingException {
	    ...
	    //    final String appName = "";
	      ...
	      //  final String moduleName = "EJBModule";
	        ...
	        final String beanName = "GroupStatelessBean";
	        System.out.println(beanName);
	        // the remote view fully qualified class name
	   //     System.out.println(RemoteCalculator.class.getName());
	        final String viewClassName = GroupStatelessBeanRemote.class.getName();
	        // let's do the lookup
